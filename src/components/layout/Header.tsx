      ...
      >
        <div className="container mx-auto px-4 h-11 sm:h-12 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <img src={acafeSymbol} alt="ACAFE" className="h-[28px] w-auto shrink-0 drop-shadow-[0_0_6px_rgba(143,190,63,0.3)]" draggable={false} />
          ...
          >
            ...
            <img src={acafeSymbol} alt="ACAFE" className="h-[20px] w-auto" draggable={false} />
            {/* Label — mobile */}
